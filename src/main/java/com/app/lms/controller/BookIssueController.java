...
public class BookIssueController {
	...
	@GetMapping("/returnByAccessno/{accessno}")
	public List<Map<String, Object>> getReturnByAccessno(@PathVariable("accessno") String accessno) {
		BookIssueVO returnObj = bookService.getReturnByAccessno(accessno);
		return returnObj.getDataList();
	}
	...
	public ResponseEntity<BookIssueVO> bookreturn(@RequestBody BookIssueVO bookVo) {
		try {
			...
			log.error("Failed to process book return", e);
